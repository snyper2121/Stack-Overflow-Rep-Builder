...
$(document).ready( function() {
	...
	$('.inspiration-getter').submit( function(e){
		...
		var tagSearch = $(this).find("input[name='tags-answers']").val();
			getAnswerers(tagSearch);
	});
	...
	function getAnswerers(tagsToSearchFor){
		var rootUrl = "http://api.stackexchange.com/2.2";
		var apiKey = "U4DMV*8nvpm3EOpvf69Rxw((";
		var requestOptions = {
			url: rootUrl + "/tags/" + tagsToSearchFor + "/top-answerers/all_time?key=" + apiKey + "&site=stackoverflow&filter=default",
			method: "GET"
		}
...
//Request URL:http://api.stackexchange.com/2.2/tags/jquery/top-answerers/all_time?key=U4DMV*8nvpm3EOpvf69Rxw((&site=stackoverflow&filter=default
